...
class EditSkillForm extends ConsumerStatefulWidget {
  const EditSkillForm({super.key, required this.skill});

  static String name = 'edit-skill-form';
              ...
              onPressed: loadingSave
                  ...
                  : () async {
                      ...
                      if (categories.isEmpty) {
                        ...
                        await widget.skill.update({
                          'title': _titleController.text,
                          'description': _descriptionController.text,
                          'image': image,
                          'pricePerHour': double.parse(_priceController.text),
                          'categories': categories,
                          'favorites': widget.skill.favorites,
                          'saved': widget.skill.saved,
                        });
